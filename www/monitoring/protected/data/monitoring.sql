...
--
-- Хост: 127.0.0.1
-- Время создания: Ноя 10 2014 г., 14:45
...
(30, '2014-10-31 15:46:13', '', '', 5, 1, 'fig ego znaet', 11),
...
(4, 'Травилка 2', '', 1),
(5, 'АВК', 'Старое', 1),
(6, 'Цех№1', 'Травмльное отделение', 3),
(7, 'Delphi', 'Delphi2', 1);
...
(5, 'Пролив', 'Датчик пролива', '-'),
(6, 'Концентрация', 'Датчик концентрации газа', '-');
...
(10, 'mishapk', '$2a$13$quv9q0vEtnfPCnRj431qMu7TE3WrtvKXUdVyb93hoTd6vZmh2ZSpu', 'mishapk@ya.ru', 0, 'root', '2014-11-07 15:19:01'),
(11, 'titan', '$2a$13$Dkp159j.70Kc8Kav88YBf.jKDcfkURhOouW426DRTcqWr6GsJtdtK', 'titan@mail.ru', 3, 'device', '2014-11-07 15:25:50'),
(12, 'titan2', '$2a$13$R7xZ92V0Ub4VZuZtr67Bd.F1sDJLsgks8yKH8/c3wlmkCmyjmMGIK', 'titan2@mail.ru', 3, 'admin', '2014-10-30 13:43:32');
