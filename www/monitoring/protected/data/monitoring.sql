...
--
-- Хост: 127.0.0.1
-- Время создания: Дек 16 2014 г., 21:58
...
(386, '2014-12-16 21:02:02', '', '', 14, 5, 'StartSystem', 11),
(387, '2014-12-16 21:03:01', '', '', 14, 0, 'TestInterval', 11),
(388, '2014-12-16 21:04:01', '', '', 14, 0, 'TestInterval', 11),
(389, '2014-12-16 21:04:43', '', '', 9, 1, 'Внимание!  Склад Концентрация паров диаксида озота в воздухе рабочей зоны достигла  до критического значения (Порог I) [21:04:34]', 11),
(390, '2014-12-16 21:05:00', '', '', 14, 0, 'TestInterval', 11),
(391, '2014-12-16 21:06:01', '', '', 14, 0, 'TestInterval', 11),
(392, '2014-12-16 21:06:09', '', '', 9, 1, 'Внимание!  Склад Концентрация паров диаксида озота в воздухе рабочей зоны достигла  до критического значения (Порог I) [21:06:06]', 11),
(393, '2014-12-16 21:06:34', '', '', 9, 4, 'Внимание!  Склад Концентрация паров диаксида озота в воздухе рабочей зоны достигла  нормы [21:06:31]', 11),
(394, '2014-12-16 21:06:37', '', '', 7, 2, 'Внимание!  Склад Пролив кислотного расствора в травильном отделении достиг  критического значения (Порог II) [21:06:34]', 11),
(395, '2014-12-16 21:07:00', '', '', 14, 0, 'TestInterval', 11),
(396, '2014-12-16 21:08:01', '', '', 14, 0, 'TestInterval', 11),
(397, '2014-12-16 21:08:20', '', '', 7, 3, 'Внимание!  Склад Пролив - отказ датчика.  [21:08:18]', 11),
(398, '2014-12-16 21:09:01', '', '', 14, 0, 'TestInterval', 11);
...
(14, 0, 'Система', 'Системная информация', 0, 0, 0, 0, 6);
...
(-2, 'Стоп система', 'Стоп система', '', '', '', '', ''),
(-1, 'Старт системы', 'Старт системы', '', '', '', '', ''),
...
(10, 'mishapk', '$2a$13$quv9q0vEtnfPCnRj431qMu7TE3WrtvKXUdVyb93hoTd6vZmh2ZSpu', 'mishapk@ya.ru', 0, 'root', '2014-12-16 18:39:33'),
(11, 'titan', '$2a$13$Dkp159j.70Kc8Kav88YBf.jKDcfkURhOouW426DRTcqWr6GsJtdtK', 'titan@mail.ru', 3, 'device', '2014-12-16 19:09:00'),
(12, 'titan2', '$2a$13$R7xZ92V0Ub4VZuZtr67Bd.F1sDJLsgks8yKH8/c3wlmkCmyjmMGIK', 'titan2@mail.ru', 3, 'admin', '2014-12-15 11:39:00'),
(13, 'titano', '$2a$13$RrCjyQXjOoNAo6WoXTYDw.AgRtJ6oRC51vpY7eP8MQVt2YBHpi8IG', 'mishapk@ya.ru', 3, 'user', '2014-12-16 18:42:17');

-- --------------------------------------------------------

--
-- Структура таблицы `tevents`
--
...
--
-- Дамп данных таблицы `tevents`
--

INSERT INTO `tevents` (`id`, `created`, `sensor_id`, `level_id`) VALUES
(1, '2014-12-01', 1, 1),
(2, '2014-12-01', 1, 1),
(3, '2014-12-02', 1, 1),
(4, '2014-12-03', 1, 1),
...
ALTER TABLE `tbl_sensor`
  ADD CONSTRAINT `tbl_sensor_ibfk_3` FOREIGN KEY (`id_type`) REFERENCES `tbl_stype` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
